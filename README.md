...
#### Observations:
* This plot is next to useless, and not quite worth the effort ot make it actually readable.
...
* It is a Shooter (rifle) class main weapon, which is considered the most versitile of the main weapon types.
